...
const DEMO = [
  ...
  {id:"etag1",date:"2024-02-22",title:"車道增設ETAG及車牌辨識系統",equipment_type:"停車場",location:"新北市淡水區新市三路一段50號",
    problem_description:"建商原始規劃未納入ETag及車牌辨識系統，社區接管後追加委託中保建置。因系統規格於採購前未明確定義，導致車辨系統與既有停車場設備整合過程問題頻繁。",
    solution:"委託中保科技建置車道ETag及車牌辨識系統，含影像監視系統銷售契約。",
    selected_vendor:"中興保全科技股份有限公司台北分公司",
    amount_total:320020,warranty:3,urgency:"low",
    contract_no:"A1384017",
    contract_date:"2024-02-22",
    payment_terms:"簽約30%（$261,000）、交貨安裝完成60%（$482,000）、驗收完成10%（$72,000）轉履約保證金滿三個月後退還",
    contract_notes:"標的物付清全款後所有權移轉；七日內配合驗收；保固三年（ETag系統一年）；合約書未給分公司代表人副署簽章者無效",
    completion_status:"已完工",
    tags:["停車場","車辨","ETag","中保","影像監視","合約存檔"],
    contract_url:"",
    lesson_learn:{
      background:"建商原始規劃未納入ETag及車牌辨識系統，社區接管後追加委託中保建置。",
      what_happened:"因系統規格於採購前未明確定義，導致車辨系統與既有停車場設備整合過程問題頻繁，系統整合不順利。",
      root_cause:"追加工程未事先進行完整的系統規格定義與相容性評估，建商移交時亦未提供完整設備資料。",
      improvements:[
        "追加設備前必須先取得建商原始設備規格書",
        "要求廠商提供系統整合測試計畫，驗收前完成全流程測試",
        "合約中明訂整合問題的責任歸屬與處理時限",
        "重大設備採購建議先進行小規模POC（概念驗證）"
      ]
    }
  },
  ...
  {id:"contract_ljclean_115",date:"2026-03-16",title:"綠佳有限公司清潔承攬合約115年度",equipment_type:"清潔",location:"全區",
    problem_description:"宏盛水悅社區全棟公共區域環境清潔維護服務，含各棟梯廳、地下停車場、中庭、外圍、公設等區域日常清潔及定期專項工程。",
    solution:"委託綠佳有限公司承攬，派駐清潔員10名，早班6名（08:00-17:00）、晚班1名（12:00-21:00），依宏盛水悅(1)至(7)號服務排程執行。",
    selected_vendor:"綠佳有限公司",
    amount_total:448000,
    warranty:0,
    urgency:"low",
    completion_status:"履約中",
    tags:["清潔","年約","履約中","合約存檔","定期服務"],
    contract_no:"115-綠佳-清潔-001",
    contract_date:"2026-03-16",
    contract_start:"2026-05-01",
    contract_end:"2027-04-30",
    payment_terms:"每月448,000元，乙方於每月20日前開立發票，甲方於次月10日前匯款。匯款至中國信託銀行北蘆洲分行，戶名：綠佳有限公司，帳號：259-54020400-7",
    contract_notes:"試用期3個月。出勤不足依比例折減費用另加50%賠償；當月5次以上不足提高至100%。保證金新台幣10萬元，合約期滿7日內退還。春節初一至初三派員2人力不額外收費。廠商不得將合約轉包。爭議以台灣士林地方法院為第一審管轄。",
    contract_url:"",
    annual_total:5376000,
    staff_count:10,
    vendor_tax_id:"90776101",
    vendor_contact:"吳國維",
    vendor_phone:"02-2285-1059",
    vendor_address:"新北市三重區中正北路380巷7號1樓",
    special_tasks:[
      "水塔清洗（一年2次）",
      "社區全區消毒（一年2次）",
      "一樓大理石晶化保養（一年4次）",
      "各棟輕食區地面拋光石英磚美化保養（一年2次）",
      "地下停車場上方管路及各停車格地面大清（一年2次）",
      "社區內外圍地面高壓水刀清洗（一年2次）",
      "中庭景觀池、車道上景觀池及F棟前景觀池高壓水刀清洗（一年2次）",
      "截水溝格網淤泥清理（一年2次）",
      "大樓三樓戲水池、中庭鵝卵石循環水高壓清洗（一年1次）",
      "大廳外景觀池清洗（每月1次）",
      "各棟頂樓及三樓戲水池區公共落水頭清理（每週1次）",
      "大廳挑高玻璃清潔擦拭（每月1次）",
      "社區內外圍柱體高壓清洗（每年1次）"
    ]
  },
  {id:"cctv_avisotech_115",date:"2026-04-17",title:"監視錄影主機及攝影機故障更新案",equipment_type:"消防系統",location:"全區",
    problem_description:"社區監視錄影主機DVR3一台及監視攝影機21台故障，經檢測老化無法修復。故障攝影機分布於DVR1(1.8.9.16)、DVR2(2.6)、DVR3(7)、DVR4(5.8)、DVR6(7.8.10.12)、DVR7(13.15)、DVR9(3)、DVR15(4)、DVR19(12)、DVR20(9)、DVR21(4.6)等多組主機。",
    solution:"委託翊峰科技股份有限公司更換，含16路數位混合型錄影主機×1（DVR3沿用舊硬碟）、200萬高清槍型攝影機×21台、攝影機更換工資。議價85折後含稅111,116元。另請翊峰順便調整其他攝影機角度。",
    selected_vendor:"翊峰科技股份有限公司",
    amount_total:111116,
    warranty:1,
    urgency:"high",
    completion_status:"已完工",
    tags:["監視系統","CCTV","攝影機","DVR","比價","已完工"],
    contract_no:"水悅管(工)字115041702號",
    contract_date:"2026-04-17",
    payment_terms:"匯款/現金付款",
    contract_notes:"DVR3沿用舊硬碟，如有故障另提報價。保固新品一年。另請翊峰順便調整其他攝影機角度。",
    decision:{
      vendor:"翊峰科技股份有限公司",
      amount:"111116",
      date:"2026-04-10",
      followup:"",
      reason:"115年4月10日管委會決議通過，原報價130,725元，議價85折後111,116元（含稅）。同意票10票，不同意0票。"
    },
    quote_original:130725,
    discount_rate:"85折",
    equipment_detail:[
      "16路數位混合型錄影主機×1（昇銳 HS-HU6321）$25,000",
      "200萬高清槍型攝影機×21台（昇銳 HS-T108BJ）$4,500/台，共$94,500",
      "攝影機更換工資×1式 $5,000"
    ]
  },
  {id:"contract_law_115",date:"2026-05-05",title:"台經法律事務所法律顧問服務契約115年度",equipment_type:"其他",location:"全區",
    problem_description:"社區管委會委託台經法律事務所提供常年法律諮詢顧問服務，涵蓋非訟法務諮詢、規約廠商契約審閱、存證信函、律師函、訴訟代理等服務。",
    solution:"委託台經法律事務所沈晉瑋律師擔任常年法律顧問，提供社區管理法律後盾。",
    selected_vendor:"台經法律事務所",
    amount_total:30000,
    warranty:0,
    urgency:"low",
    completion_status:"履約中",
    tags:["法律顧問","年約","履約中","合約存檔"],
    contract_date:"2026-05-05",
    contract_start:"2026-05-05",
    contract_end:"2027-05-04",
    payment_terms:"簽約日預收年度服務公費新台幣30,000元（不含執行業務所得10%）",
    contract_notes:"免費項目：簡易法律諮詢、規約及廠商契約審閱、存證信函、律師函、聲請公示送達。收費項目：列席管委會議每趟每人次8,000元、訴訟代理8折優惠。訴訟代理費視案件複雜度另行報價。",
    vendor_contact:"沈晉瑋律師",
    vendor_phone:"0979-995-625 / 02-77091158",
    vendor_address:"臺北市信義區忠孝東路二段88號16樓1603室",
    bank_name:"台北國泰世華銀行（013）西松分行",
    account_name:"台經法律事務所 沈晉瑋",
    account_number:"264-035-012378",
    annual_total:30000
  },
  {id:"contract_security_115",date:"2026-06-01",title:"慶豐保全駐衛保全服務契約115年度",equipment_type:"其他",location:"全區",
    problem_description:"宏盛水悅社區委託慶豐保全股份有限公司提供全年駐衛保全服務，負責門禁管制、車輛進出管理、監視系統操作、緊急事件處理等安全管理工作。",
    solution:"委託慶豐保全股份有限公司派駐保全9名，24小時輪班制（早班3人/晚班3人），提供全面安全管理服務。",
    selected_vendor:"慶豐保全股份有限公司",
    amount_total:467775,
    warranty:0,
    urgency:"low",
    completion_status:"履約中",
    tags:["保全","年約","履約中","合約存檔","24小時"],
    contract_date:"2026-06-01",
    contract_start:"2026-06-01",
    contract_end:"2027-05-31",
    payment_terms:"每月467,775元（含稅），乙方於當月20日前請款，甲方於次月10日前付款。匯款至第一銀行埔墘分行，帳號：238-10-030590",
    contract_notes:"派駐保全9名，單價49,500元/人。服務含固定哨位、巡邏哨、監視系統操作、緊急廣播、停車場管理、鑰匙管制、火災預防。如人數不足依比例折減費用。提前終止需一個月前通知並賠償一個月服務費違約金。",
    vendor_contact:"陳勇志",
    vendor_phone:"02-2950-9099",
    vendor_address:"220新北市板橋區民生路一段33號17樓之2A",
    vendor_tax_id:"89850551",
    bank_name:"第一銀行埔墘分行",
    account_name:"慶豐保全股份有限公司",
    account_number:"238-10-030590",
    staff_count:9,
    annual_total:5613300
  },
  {id:"contract_pm_115",date:"2026-06-01",title:"美麗華物業管理維護契約115年度",equipment_type:"其他",location:"全區",
    problem_description:"宏盛水悅社區委託美麗華公寓大廈管理維護股份有限公司提供全年物業管理維護服務，涵蓋公共事務管理、設施管理、修繕監督、財務帳務等全方位物業管理。",
    solution:"委託美麗華物業派駐管理服務中心人員11名：經理1、副理1、行政副理1、財務秘書1、行政秘書5、吧檯秘書2，提供全面物業管理服務。",
    selected_vendor:"美麗華公寓大廈管理維護股份有限公司",
    amount_total:606025,
    warranty:0,
    urgency:"low",
    completion_status:"履約中",
    tags:["物管","年約","履約中","合約存檔","美麗華"],
    contract_date:"2026-06-01",
    contract_start:"2026-06-01",
    contract_end:"2027-05-31",
    payment_terms:"每月606,025元（含稅），乙方於當月20日前請款，甲方於次月10日前付款。匯款至第一銀行埔墘分行，帳號：238-10-030956",
    contract_notes:"派駐11名管理人員。履約保證金10萬元，合約期滿無息退還。回饋項目：年度活動贊助金$50,000、免費政府包租代管媒合服務。提前終止需一個月前通知並賠償一個月違約金。爭議以臺灣新北地方法院為第一審。",
    vendor_contact:"蘇麗華",
    vendor_phone:"02-2950-9099",
    vendor_address:"220新北市板橋區民生路一段33號17樓之2A",
    vendor_tax_id:"12929587",
    bank_name:"第一銀行埔墘分行",
    account_name:"美麗華公寓大廈管理維護股份有限公司",
    account_number:"238-10-030956",
    staff_count:11,
    annual_total:7272300,
    bonus_items:["年度活動贊助金$50,000","免費政府包租代管媒合專案服務","免費法律資訊服務","免費財務系統建置","每月高階幹部陪同例會","每月現場督導巡視4次以上"]
  },
];
...
export default function App(){
  ...
  const extractOne = async f => {
    ...
    const fileMsg = isPdf
      ? {type:"document",source:{type:"base64",media_type:"application/pdf",data:b64}}
      : {type:"image",source:{type:"base64",media_type:"image/jpeg",data:b64}};
    const prompt = "你是台灣社區管委會文件分析師。從這份文件萃取修繕案件與合約資訊，只回傳JSON不含markdown。欄位(找不到填null)：title,date(YYYY-MM-DD民國年+1911),equipment_type(電梯/消防系統/給排水/景觀綠化/門禁鐵捲門/停車場/公共照明/空調/病蟲害防治/其他),location,problem_description,solution,selected_vendor,amount_total(含稅數字),warranty(年數字),urgency(high/medium/low),tags(陣列),contract_no(合約編號),contract_date(簽約日期YYYY-MM-DD),construction_date(施工日期YYYY-MM-DD),completion_date(完工日期YYYY-MM-DD),payment_terms(付款方式),contract_notes(合約重點條款),contract_url(合約影本連結如有)";
    ...
    <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,alignItems:"start"}}>
        ...
        {pending.length>0&&<div style={{marginTop:20}}>
          ...
          {pending.map((r,idx)=><div key={r.id} style={{...S.card,marginBottom:16}}>
            ...
            <div style={S.cb}><div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10}}>
              {[["日期","date"],["設備類型","equipment_type"],["廠商","selected_vendor"],["含稅金額","amount_total"],["保固年限","warranty"],["地點","location"],["合約編號","contract_no"],["簽約日期","contract_date"],["施工日期","construction_date"],["完工日期","completion_date"]].map(([l,k])=><div key={k}><label style={S.lbl}>{l}</label><input style={S.inp} value={r[k]||""} onChange={e=>setPending(p=>p.map((x,i)=>i===idx?{...x,[k]:e.target.value}:x))}/></div>)}
              <div style={{gridColumn:"span 3"}}><label style={S.lbl}>付款方式</label><input style={S.inp} value={r.payment_terms||""} onChange={e=>setPending(p=>p.map((x,i)=>i===idx?{...x,payment_terms:e.target.value}:x))}/></div>
              <div style={{gridColumn:"span 3"}}><label style={S.lbl}>合約重點條款</label><input style={S.inp} value={r.contract_notes||""} onChange={e=>setPending(p=>p.map((x,i)=>i===idx?{...x,contract_notes:e.target.value}:x))}/></div>
            </div></div>
          </div>)}
        </div>}
      </div>
      <div style={S.card}>
        ...
        <div style={S.cb}>
          ...
          <div style={{borderTop:"1px solid #e2e0d8",paddingTop:14,marginBottom:14}}>
            <div style={{fontSize:12,fontWeight:600,color:"#1d4ed8",marginBottom:10}}>📄 合約資訊（選填）</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
              <div><label style={S.lbl}>合約編號</label><input style={S.inp} value={mForm.contract_no||""} onChange={e=>setMForm(f=>({...f,contract_no:e.target.value}))} placeholder="CT-2026-001"/></div>
              <div><label style={S.lbl}>簽約日期</label><input style={S.inp} type="date" value={mForm.contract_date||""} onChange={e=>setMForm(f=>({...f,contract_date:e.target.value}))}/></div>
              <div><label style={S.lbl}>施工日期</label><input style={S.inp} type="date" value={mForm.construction_date||""} onChange={e=>setMForm(f=>({...f,construction_date:e.target.value}))}/></div>
              <div><label style={S.lbl}>完工日期</label><input style={S.inp} type="date" value={mForm.completion_date||""} onChange={e=>setMForm(f=>({...f,completion_date:e.target.value}))}/></div>
            </div>
            <div style={{marginBottom:10}}><label style={S.lbl}>付款方式</label><input style={S.inp} value={mForm.payment_terms||""} onChange={e=>setMForm(f=>({...f,payment_terms:e.target.value}))} placeholder="定金30%、工程款60%、尾款10%"/></div>
            <div><label style={S.lbl}>合約重點條款</label><textarea style={{...S.inp,height:56,resize:"vertical"}} value={mForm.contract_notes||""} onChange={e=>setMForm(f=>({...f,contract_notes:e.target.value}))} placeholder="保固1年、逾期罰款、材料品牌規定"/></div>
            <div style={{marginTop:10}}><label style={S.lbl}>📎 合約影本連結（Google Drive / OneDrive）</label><input style={S.inp} value={mForm.contract_url||""} onChange={e=>setMForm(f=>({...f,contract_url:e.target.value}))} placeholder="貼上雲端硬碟分享連結"/></div>
          </div>
      ...
      {modal&&<div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.4)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center"}} onClick={()=>setModal(null)}>
        <div style={{background:"#fff",borderRadius:14,width:560,maxWidth:"90vw",maxHeight:"85vh",overflow:"auto",boxShadow:"0 8px 32px rgba(0,0,0,.15)"}} onClick={e=>e.stopPropagation()}>
          ...
          <div style={{padding:22}}>
            ...
            {/* Contract info */}
            {(modal.contract_no||modal.contract_date||modal.payment_terms||modal.contract_notes)&&<div style={{marginTop:14,background:"#dbeafe",borderRadius:8,padding:"12px 14px"}}>
              <div style={{fontWeight:600,fontSize:13,color:"#1d4ed8",marginBottom:8}}>📄 合約資訊</div>
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,fontSize:12}}>
                {modal.contract_no&&<div><span style={{color:"#888580"}}>合約編號：</span><span style={{fontWeight:500}}>{modal.contract_no}</span></div>}
                {modal.contract_date&&<div><span style={{color:"#888580"}}>簽約日期：</span><span style={{fontWeight:500}}>{modal.contract_date}</span></div>}
                {modal.construction_date&&<div><span style={{color:"#888580"}}>施工日期：</span><span style={{fontWeight:500}}>{modal.construction_date}</span></div>}
                {modal.completion_date&&<div><span style={{color:"#888580"}}>完工日期：</span><span style={{fontWeight:500}}>{modal.completion_date}</span></div>}
                {modal.payment_terms&&<div style={{gridColumn:"span 2"}}><span style={{color:"#888580"}}>付款方式：</span><span style={{fontWeight:500}}>{modal.payment_terms}</span></div>}
                {modal.contract_notes&&<div style={{gridColumn:"span 2"}}><span style={{color:"#888580"}}>合約重點：</span><span style={{fontWeight:500}}>{modal.contract_notes}</span></div>}
                {modal.contract_url&&<div style={{gridColumn:"span 2",marginTop:4}}>
                  <a href={modal.contract_url} target="_blank" rel="noopener noreferrer" style={{display:"inline-flex",alignItems:"center",gap:6,background:"#1d4ed8",color:"#fff",borderRadius:7,padding:"6px 14px",fontSize:12,fontWeight:600,textDecoration:"none"}}>
                    📎 查看合約影本
                  </a>
                </div>}
              </div>
            ...
            {/* Lesson Learn */}
            {modal.lesson_learn&&<div style={{marginTop:16}}>
              <div style={{fontWeight:600,fontSize:13,marginBottom:10}}>📚 Lesson Learn</div>
              <div style={{background:"#fef3c7",borderRadius:8,padding:"12px 14px",marginBottom:8}}>
                <div style={{fontWeight:600,fontSize:12,color:"#b45309",marginBottom:4}}>📋 背景</div>
                <p style={{fontSize:12,color:"#444",lineHeight:1.7,margin:0}}>{modal.lesson_learn.background}</p>
              </div>
              <div style={{background:"#fee2e2",borderRadius:8,padding:"12px 14px",marginBottom:8}}>
                <div style={{fontWeight:600,fontSize:12,color:"#b91c1c",marginBottom:4}}>⚠ 根本原因</div>
                <p style={{fontSize:12,color:"#444",lineHeight:1.7,margin:0}}>{modal.lesson_learn.root_cause}</p>
              </div>
              <div style={{background:"#e8f4ef",borderRadius:8,padding:"12px 14px"}}>
                <div style={{fontWeight:600,fontSize:12,color:"#1b4332",marginBottom:6}}>✅ 改善建議</div>
                {(modal.lesson_learn.improvements||[]).map((s,i)=><div key={i} style={{fontSize:12,color:"#1b4332",padding:"2px 0"}}>• {s}</div>)}
              </div>
            </div>}
